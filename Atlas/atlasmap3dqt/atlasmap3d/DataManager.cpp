...
{
    AtlasMainWindow* mainWindow = static_cast<AtlasMainWindow*>(parent());
...
const osgEarth::GeoExtent* DataManager::getExtent(const QString& name)
{
    ...
    return record ? record->extent() : nullptr;
}
...
{
    QDockWidget* tableDockWidget = static_cast<AtlasMainWindow*>(parent())->findChild<QDockWidget*>("attributePanel");
    ...
    QTableWidget* tableWidget = static_cast<AtlasMainWindow*>(parent())->findChild<QTableWidget*>("attributeTable");
